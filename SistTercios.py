...
if pena_min <= pena_propuesta <= lim_tercio_inf: 
    ...
    el límite del tercio inferior es de {lim_tercio_inf} meses. Muy bien\n""") 
elif pena_propuesta > lim_tercio_inf: 
    print (f""" La pena propuesta por el fiscal de {pena_propuesta} meses 
        NO está dentro del límite de tercios ya que el límite del 
        tercio inferior es de {lim_tercio_inf} meses. Ten cuidado\n """)
elif pena_propuesta < pena_min: 
    print (f""" La pena propuesta por el fiscal de {pena_propuesta} meses 
